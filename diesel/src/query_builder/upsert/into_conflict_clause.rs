...
impl<'a, F, S, D, LOf, G, Columns> IntoConflictValueClause
    for InsertFromSelect<SelectStatement<'a, F, S, D, LOf, G>, Columns>
{
    type ValueClause = InsertFromSelect<
        OnConflictSelectWrapper<SelectStatement<'a, F, S, D, LOf, G>>,
        Columns,
    >;
