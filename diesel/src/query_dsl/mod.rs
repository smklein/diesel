...
pub mod methods {
    ...
    pub use super::locking_dsl::LockingDsl;
...
pub trait QueryDsl: Sized {
    ...
    /// Adds a locking clause
    fn with_lock(self, lock: lock::AllLockingClauses) -> WithLock<Self>
    where
        Self: methods::LockingDsl,
    {
        methods::LockingDsl::with_lock(self, lock)
    }
